  ...
  return (
    <PageShell title="Case Studies" kicker="OUR WORK">
      ...
      <p className="text-slate-600 max-w-2xl leading-relaxed">
        Real strategies, measurable outcomes. Here's how we've helped businesses
        rank, grow, and win visibility across traditional search and AI-powered
        platforms.
      </p>
      ...
      <div className="mt-14 rounded-3xl bg-slate-900 p-8 md:p-10 text-white text-center shadow-xl">
        ...
        <p className="mt-2 text-sm text-slate-300 max-w-md mx-auto">
          Let's build a strategy tailored to your goals — search engines, local
          maps, and AI platforms.
        </p>
        <Link
          href="/contact"
