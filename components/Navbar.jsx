...
const links = [
  ...
  { href: "/casestudy", label: "CaseStudy" },
];
        ...
        <div className="flex items-center gap-2">
          ...
          {!mounted ? null : user ? (
            ...
            <>
              <Link
                href="/login"
                className="rounded-full bg-white/55 px-4 py-2 text-sm shadow-glass hover:bg-white/70 transition"
              >
                Login
              </Link>
              <Link
                href="/register"
                className="rounded-full bg-slate-900 px-4 py-2 text-sm text-white shadow-soft hover:opacity-90 transition"
              >
                Register
              </Link>
            </>
